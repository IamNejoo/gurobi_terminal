...
logger = logging.getLogger("camila")


def ejecutar_instancias_camila(semanas, turnos, participacion, base_instancias, base_resultados):
    ...
    for semana in semanas:
        ...
        for turno in turnos:
            ...
            datos = pd.read_excel(
                os.path.join(base_instancias,f"instancias_turno_{semana}",
